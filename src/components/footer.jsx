    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center md:items-center space-y-8 md:space-y-0 px-4">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="flex items-center  justify-left md:justify-start my-4">
            <i className="fas fa-phone mr-2 text-green-500"></i>
            <a href="tel:+1234567890" className="hover:text-gray-400">+92 301 0654862</a>
          </p>
          
          <p className="flex lg:items-center md:justify-start my-4">
          ...
          <p className="flex items-center  justify-center md:justify-start my-4">
            ...
            <a href="mailto:contact@mubasahar.dev" className="hover:text-gray-400">	mirzamubashar535@gmail.com</a>
          </p>
